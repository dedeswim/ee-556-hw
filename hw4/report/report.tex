...
Next, an experiment is run using a specific $\beta = 1000$ for the as coefficient for the $\mathcal{K}$ quadratic penalty function. With this setting we obtain a final k-means value of $48.6801$, and what is plotted in \Cref{fig:beta-convergence}, \Cref{fig:beta-relative-obj-res} and \Cref{fig:beta-heatmap}. The obtained misclassification rate is $0.1330$, while the final objective value is $-128.41$, which is lower than the provided $57.05339187$.
